            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800/60">
              {isLoading ? (
                ...
                filteredHearings.map((h, idx) => (
                  <tr key={idx} className="transition-colors border-b border-slate-200 dark:border-slate-800/60">
                    <td className="py-3.5 px-3 text-center font-mono font-bold text-[#4a3e33] dark:text-slate-400">
                      {idx + 1}
                    </td>
                    <td className="py-3.5 px-3 font-mono font-bold text-[#0F172B] dark:text-[#cca776]">
                      {h.caseFileNo}
                    </td>
                    <td className="py-3.5 px-4 font-bold text-[#0F172B] dark:text-white">
                      {h.courtDivision}
                    </td>
                    <td className="py-3.5 px-4 font-mono text-[#0F172B] dark:text-white">
                      <div className="font-bold">{h.caseNumber}</div>
                      <div className="text-[10px] text-[#4a3e33] dark:text-slate-400 font-sans">{h.caseType}</div>
                    </td>
                    <td className="py-3.5 px-4 font-bold text-[#0F172B] dark:text-slate-200">
                      {h.institutionName}
                    </td>
                    <td className="py-3.5 px-4 text-[#4a3e33] dark:text-slate-300">
                      <div className="truncate max-w-[200px]" title={h.parties}>
                        {h.parties}
                      </div>
                    </td>
                    <td className="py-3.5 px-4 text-[#0F172B] dark:text-slate-200 font-bold">
                      {h.advocateName}
                    </td>
                    <td className="py-3.5 px-4 text-[#4a3e33] dark:text-slate-400">
