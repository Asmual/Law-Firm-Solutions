                ...
                >
                  <div className="flex flex-wrap sm:flex-nowrap items-center justify-between gap-3">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1 rounded-lg bg-[#cbb292] group-hover:bg-[#dfceb7] group-hover:text-[#0F172B] px-3 py-1 text-xs font-bold text-[#0F172B] hover:bg-[#cca776] transition-all border border-[#ab8c67] shrink-0 whitespace-nowrap cursor-pointer"
                    >
