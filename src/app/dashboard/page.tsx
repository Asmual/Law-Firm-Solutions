        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="space-y-2">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-white">
              Law Firm Legal Solutions — Practice Dashboard
            </h1>
            <p className="text-sm text-slate-300 max-w-2xl leading-relaxed">
              {currentUser ? (
                <>
                  Logged in as <strong className="text-[#cca776]">{currentUser.name}</strong> ({currentUser.role.toUpperCase()} • {currentUser.chamberDesignation}). Real-time litigation analytics, court cause lists, and bank file tracking.
                </>
              ) : (
                "Real-time bank litigation tracking, High Court & Artha Rin suit management, and automated corporate letterhead reporting."
              )}
            </p>
          </div>
